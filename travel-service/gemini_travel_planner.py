...
{{
  ...
  "pre_trip_transportation": {{
    ...
    "options": [
      {{
        "mode": "bus",
        "operator": "Hanif Enterprise",  let the llm decide the operator musst be actual operator on the route
  ...
  "daily_itinerary": [
    ...
    // Additional days will follow the same structure
    // This is just a placeholder to show that more days should be included
    // The actual itinerary must include exactly {day_count} days
