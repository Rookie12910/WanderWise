...
def weather_suggestion():
    ...
    """
    Generate a weather-based suggestion for a trip using OpenAI.
    ...
    try:
        ...
        # Compose a much more detailed prompt for OpenAI based on weather
...
"""
        ...
        from smart_travel_planner import generate_openai_suggestion
        suggestion = generate_openai_suggestion(prompt)
        print(f"[DEBUG] OpenAI suggestion: {suggestion}")
